...
PersonalCenter.prototype.openLayer = function () {
    ...
    open_layer.style.background = "url(static/images/personal_center.png) no-repeat";
    ...
    // span_close.src = "./imag/close.png";
    // span_close.style.position="absolute";
    // span_close.style.width = "100px";
    // span_close.style.height = "100px";
    // span_close.style.right = "0";
    // span_close.onmouseover = function(){
    //     //提示信息
    //
    // }
    // span_close.style.display = "none";
